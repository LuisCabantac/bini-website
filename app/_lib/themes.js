...
export const navigationTheme = {
  ...
  homeIsNav: "bg-[linear-gradient(to_bottom,#c92a2ae4_55%,#00000099_45%)]",
  defaultNotSticky:
    "bg-gradient-to-b from-[rgba(62,140,148,0.6)] to-[rgba(89, 200, 212, 0.055)] fade-in",
  defaultIsSticky: "bg-[#59c8d4]/90",
  defaultIsNav: "bg-[linear-gradient(to_bottom,#59c8d4e4_55%,#00000099_45%)]",
};
...
export const latestReleaseCardTextTheme = {
  ...
  paragraph: "text-[#f57878]",
};

export const eventCardList = "border-[#8bd9e1] bg-[#cdeff2] text-[#14484D]";
